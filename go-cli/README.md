...
AQL-driven CLI and REPL for the TempmailApi2 SDK. Positional arguments are
...
./tempmail-api2-cli load 1 domain
./tempmail-api2-cli load '{id:1}' domain
