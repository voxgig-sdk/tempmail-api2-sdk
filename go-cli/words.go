...
func registerSDKWords(r *eng.Registry, client *sdk.TempmailApi2SDK) {
...
func runOp(client *sdk.TempmailApi2SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
