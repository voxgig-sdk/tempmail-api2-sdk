...
const testSeed = `map[string]any{"entity": map[string]any{"domain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "email": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "inbox": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
