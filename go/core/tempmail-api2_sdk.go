...
func (sdk *TempmailApi2SDK) OptionsMap() map[string]any {
...
func (sdk *TempmailApi2SDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TempmailApi2SDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TempmailApi2SDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TempmailApi2SDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TempmailApi2SDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TempmailApi2SDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TempmailApi2SDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TempmailApi2SDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TempmailApi2SDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TempmailApi2SDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *TempmailApi2SDK) Domain(data map[string]any) TempmailApi2Entity {
...
func (sdk *TempmailApi2SDK) Email(data map[string]any) TempmailApi2Entity {
...
func (sdk *TempmailApi2SDK) Inbox(data map[string]any) TempmailApi2Entity {
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *TempmailApi2SDK {
	...
	sdk := NewTempmailApi2SDK(sdkopts)
	sdk.Mode = "test"
