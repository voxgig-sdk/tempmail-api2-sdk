...
The Golang SDK for the TempmailApi2 API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/tempmail-api2-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/tempmail-api2-sdk=../path/to/github.com/voxgig-sdk/tempmail-api2-sdk
```
...
```
TEMPMAIL-API2_TEST_LIVE=TRUE
TEMPMAIL-API2_APIKEY=<your-key>
```
...
| `Email` | `(data map[string]any) TempmailApi2Entity` | Create a Email entity instance. |
| `Inbox` | `(data map[string]any) TempmailApi2Entity` | Create a Inbox entity instance. |
...
```
github.com/voxgig-sdk/tempmail-api2-sdk/
...
The root package (`github.com/voxgig-sdk/tempmail-api2-sdk`) re-exports everything needed
