...
func NewInboxEntity(client *core.TempmailApi2SDK, entopts map[string]any) *InboxEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InboxEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// InboxLoadMatch and returns an Inbox. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *InboxEntity) LoadTyped(reqmatch InboxLoadMatch, ctrl map[string]any) (Inbox, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Inbox{}, err
	}
	return typedFrom[Inbox](res), nil
}



func (e *InboxEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *InboxEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// InboxCreateData and returns an Inbox. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *InboxEntity) CreateTyped(reqdata InboxCreateData, ctrl map[string]any) (Inbox, error) {
...
func (e *InboxEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// InboxRemoveMatch and returns an Inbox. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *InboxEntity) RemoveTyped(reqmatch InboxRemoveMatch, ctrl map[string]any) (Inbox, error) {
