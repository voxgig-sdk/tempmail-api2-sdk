...
#      offline in seeded test mode (TempmailApi2SDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "TempmailApi2_sdk.rb")
  SDK_CLASS = "TempmailApi2SDK"
