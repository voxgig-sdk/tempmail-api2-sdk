// Command TempmailApi2-mcp is an MCP server exposing the TempmailApi2
// SDK as MCP tools.
//
// Two tools are registered:
//
//	TempmailApi2_list  — list records of an entity
//	TempmailApi2_load  — load a single record of an entity
//
