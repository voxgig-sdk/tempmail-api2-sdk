...
type Args struct {
	Entity string         `json:"entity" jsonschema:"domain | email | inbox"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TempmailApi2SDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "tempmail-api2_list",
		Description: "List records from TempmailApi2. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "tempmail-api2_load",
		Description: "Load a single record from TempmailApi2. " +
...
func runOp(client *sdk.TempmailApi2SDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TempmailApi2SDK, name string) (sdk.TempmailApi2Entity, error) {
