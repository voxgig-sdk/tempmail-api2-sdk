...
// TempmailApi2 SDK utility: fetcher

class TempmailApi2Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TempmailApi2SDK/1.0)';
    ...
    public static function call(TempmailApi2Context $ctx, string $fullurl, array $fetchdef): array
    {
