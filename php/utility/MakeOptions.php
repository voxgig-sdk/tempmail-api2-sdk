...
// TempmailApi2 SDK utility: make_options

class TempmailApi2MakeOptions
{
    ...
    public static function call(TempmailApi2Context $ctx): array
    {
        ...
        //
        // `TempmailApi2Schema::optspec()` is built from the model:
        ...
        $optspec = TempmailApi2Schema::optspec();
