...
// TempmailApi2 SDK ratelimit feature
...
class TempmailApi2RatelimitFeature extends TempmailApi2BaseFeature
{
    ...
    private function _acquire(TempmailApi2Context $ctx): void
    {
    ...
    private function _track(TempmailApi2Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
