...
// TempmailApi2 SDK metrics feature
...
class TempmailApi2MetricsFeature extends TempmailApi2BaseFeature
{
    ...
    private function _record(TempmailApi2Context $ctx, bool $ok): void
    {
