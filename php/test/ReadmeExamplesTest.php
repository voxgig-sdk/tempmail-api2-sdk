...
// TempmailApi2 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TempmailApi2SDK::test)
...
{
    private const SDK_CLASS = 'TempmailApi2SDK';
    ...
    private const SDK_BASE = 'tempmailapi2_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../tempmailapi2_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
