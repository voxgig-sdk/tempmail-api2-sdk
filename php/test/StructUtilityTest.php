...
// TempmailApi2 SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TempmailApi2Omni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TempmailApi2Omni::structfix($now, Struct::undef()))
                        !== json_encode(TempmailApi2Omni::structfix($val, Struct::undef()))) {
