...
class InboxDirectTest extends TestCase
{
    public function test_direct_load_inbox(): void
    {
        $setup = inbox_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-inbox", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
