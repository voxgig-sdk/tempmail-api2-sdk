...
// TempmailApi2 SDK timeout feature
...
class TempmailApi2TimeoutFeature extends TempmailApi2BaseFeature
{
    ...
    private function _with_timeout(TempmailApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TempmailApi2Context $_ctx, float $ms): void
    {
        $client = $this->client;
