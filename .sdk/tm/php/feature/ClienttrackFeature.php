...
// TempmailApi2 SDK clienttrack feature
...
class TempmailApi2ClienttrackFeature extends TempmailApi2BaseFeature
{
    ...
    public function PostConstruct(TempmailApi2Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TempmailApi2-SDK';
