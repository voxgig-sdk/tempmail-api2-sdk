...
class TempmailApi2RbacFeature extends TempmailApi2BaseFeature
{
    ...
    private function _required(TempmailApi2Context $ctx): ?string
    {
    ...
    private function _reject(TempmailApi2Context $ctx, string $required): void
    {
    ...
    private function _track(TempmailApi2Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
