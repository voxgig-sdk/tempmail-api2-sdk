...
// TempmailApi2 SDK audit feature
...
class TempmailApi2AuditFeature extends TempmailApi2BaseFeature
{
    ...
    private function _emit(TempmailApi2Context $ctx, string $outcome): void
    {
