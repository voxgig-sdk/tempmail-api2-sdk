...
// TempmailApi2 SDK proxy feature
...
class TempmailApi2ProxyFeature extends TempmailApi2BaseFeature
{
    ...
    public function init(TempmailApi2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TempmailApi2Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
