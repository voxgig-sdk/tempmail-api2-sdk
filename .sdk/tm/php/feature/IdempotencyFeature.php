...
// TempmailApi2 SDK idempotency feature
...
class TempmailApi2IdempotencyFeature extends TempmailApi2BaseFeature
{
    ...
    private function _mutating(TempmailApi2Context $ctx): bool
    {
