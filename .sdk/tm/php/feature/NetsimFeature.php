...
// TempmailApi2 SDK netsim feature
...
class TempmailApi2NetsimFeature extends TempmailApi2BaseFeature
{
    ...
    private function _simulate(TempmailApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TempmailApi2Context $ctx, array $applied): void
    {
        $client = $this->client;
