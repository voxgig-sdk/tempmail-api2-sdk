...
// TempmailApi2 SDK cache feature
...
class TempmailApi2CacheFeature extends TempmailApi2BaseFeature
{
    ...
    private function _through(TempmailApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
