...
// TempmailApi2 SDK telemetry feature
...
class TempmailApi2TelemetryFeature extends TempmailApi2BaseFeature
{
    ...
    private function _close(TempmailApi2Context $ctx, bool $ok): void
    {
