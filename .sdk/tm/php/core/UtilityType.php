...
// TempmailApi2 SDK utility type

class TempmailApi2Utility
{
    ...
    public static function copy(TempmailApi2Utility $src): TempmailApi2Utility
    {
        $u = new TempmailApi2Utility();
        $u->clean = $src->clean;
        $u->done = $src->done;
