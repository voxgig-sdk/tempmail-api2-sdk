...
// TempmailApi2 SDK utility: graphql
//
...
class TempmailApi2Graphql
{
    ...
    // equivalent.
    public static function body(TempmailApi2Context $ctx): mixed
    {
    ...
    public static function errors(TempmailApi2Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
