...
// TempmailApi2 SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class TempmailApi2TransformResponse
{
    public static function call(TempmailApi2Context $ctx): mixed
    {
        ...
        $transform = TempmailApi2Helpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
