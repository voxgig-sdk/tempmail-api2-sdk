...
class TempmailApi2TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TempmailApi2TestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = TempmailApi2TestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = TempmailApi2TestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
