...
(0, node_test_1.describe)('InboxDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.TempmailApi2SDK({
    ...
    (0, node_test_1.test)('direct-load-inbox', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-inbox', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.TEMPMAIL_API2_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'TEMPMAIL_API2_TEST_INBOX_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.TempmailApi2SDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['TEMPMAIL_API2_TEST_INBOX_ENTID'];
    ...
    const client = new __1.TempmailApi2SDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=InboxDirect.test.js.map