...
describe("InboxDirect", function()
  it("should direct-load-inbox", function()
    local setup = inbox_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-inbox", setup.live and "live" or "unit")
...
function inbox_direct_setup(mockres)
