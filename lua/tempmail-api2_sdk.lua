...
local TempmailApi2SDK = {}
TempmailApi2SDK.__index = TempmailApi2SDK
...
TempmailApi2SDK._make_feature = _make_feature


function TempmailApi2SDK.new(options)
  local self = setmetatable({}, TempmailApi2SDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function TempmailApi2SDK:options_map()
...
function TempmailApi2SDK:get_utility()
  return Utility.copy(self._utility)
end


function TempmailApi2SDK:get_root_ctx()
  return self._rootctx
end


function TempmailApi2SDK:prepare(fetchargs)
...
function TempmailApi2SDK:direct(fetchargs)
...
-- by passing it.
function TempmailApi2SDK:_raw_request(fetchargs)
  local utility = self._utility
...
function TempmailApi2SDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "TempmailApi2SDK: graphql: " .. msg
    res.graphql = errors
  end
...
function TempmailApi2SDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = TempmailApi2SDK.new(sdkopts)
  sdk.mode = "test"
