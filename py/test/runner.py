...
class TempmailApi2TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TempmailApi2TestRunner.getenv("TEMPMAILAPI2_TEST_LIVE")
        override = TempmailApi2TestRunner.getenv("TEMPMAILAPI2_TEST_OVERRIDE")
        ...
        explain = TempmailApi2TestRunner.getenv("TEMPMAILAPI2_TEST_EXPLAIN")
