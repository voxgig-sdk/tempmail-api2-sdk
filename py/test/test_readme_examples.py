# TempmailApi2 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TempmailApi2SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TempmailApi2SDK(...) and TempmailApi2SDK.test(...) become
#      TempmailApi2SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "tempmailapi2_sdk"
_SDK_CLASS = "TempmailApi2SDK"
