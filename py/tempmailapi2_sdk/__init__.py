...
from tempmailapi2_sdk.utility import register

# Load features
from tempmailapi2_sdk.feature.base_feature import TempmailApi2BaseFeature
from tempmailapi2_sdk.features import _has_feature, _make_feature
...
class TempmailApi2SDK:
    ...
    def __init__(self, options=None):
        ...
        utility = TempmailApi2Utility()
        self._utility = utility

        from tempmailapi2_sdk.config import shared_config
    ...
    def get_utility(self):
        return TempmailApi2Utility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TempmailApi2SDK: graphql: " + str(msg))
            res["graphql"] = errors
