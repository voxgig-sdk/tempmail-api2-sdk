...
from tempmailapi2_sdk.core.control import TempmailApi2Control
...
from tempmailapi2_sdk.core.helpers import get_ctx_prop, to_map
...
class TempmailApi2Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, TempmailApi2Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, TempmailApi2Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TempmailApi2Response):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TempmailApi2Error(code, msg, self)
